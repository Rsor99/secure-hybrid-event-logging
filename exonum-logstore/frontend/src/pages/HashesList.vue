...
export default {
  ...
  methods: {
    async load () {
      this.loading = true
      try {
        const data = await this.$blockchain.getHashes(this.offset, this.limit)
